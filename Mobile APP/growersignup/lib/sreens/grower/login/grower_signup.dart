...
class _GrowerSignupPageState extends State<GrowerSignupPage> with TickerProviderStateMixin {
  ...
  void _navigateToNextPage() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => GrowerCreateAccountPage(email: _emailController.text.trim()),
      ),
    );
  }
