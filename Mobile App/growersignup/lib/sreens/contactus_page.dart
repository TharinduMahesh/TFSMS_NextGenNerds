...
class _ContactUsPageState extends State<ContactUsPage> {
  ...
  final String whatsappNumber = '94778585465'; // Use international format without '+' for wa.me link
                      ...
                      child: Column(
                        children: [
                          _buildContactRow(
                            ...
                            onTap: () => _makePhoneCall(phoneNumber1), // Launch with the first number
                          ),
                          ...
                          _buildContactRow(
                           ...
                           _buildContactRow(
                            ...
                            title: 'Whatsapp',
                            detail: '$phoneNumber1 / $phoneNumber2',
                            onTap: () => _openWhatsapp(whatsappNumber), // Use the specific whatsapp number
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildContactRow({
    ...
    return InkWell( // Make the entire row tappable
      onTap: onTap,
      borderRadius: BorderRadius.circular(15.0), // Match container's border radius for ripple effect
      child: Padding(
