...
import 'package:growertest/grower_model.dart';
import 'package:http/http.dart' as http;

class ApiHandler {
  Future<GrowerModel> getGrowerOrder(GrowerModel growerModel) async {
    ...
    try{
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        GrowerModel newGrowerModel = GrowerModel.fromJson(jsonDecode(response.body));
