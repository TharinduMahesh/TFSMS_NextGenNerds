          ...
          return Column(
            children: [
              Container(
                ...
                child: Text(
                  "Total To Pay: Rs. ${totalAmount.toStringAsFixed(2)}",
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      title: Text("Ref: ${p.refNumber} - Rs. ${p.amount.toStringAsFixed(2)}"),
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => PaymentDetailScreen(refNumber: p.refNumber,email: widget.email),
                          ),
                        ).then((_) {
                          setState(() {
                            futurePayments = api.getPendingPayments(); // refresh after return
                          });
                        });
                      },
                    );
