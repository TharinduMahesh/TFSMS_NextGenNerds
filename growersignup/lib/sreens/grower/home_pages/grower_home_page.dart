...
class _GrowerHomePageState extends State<GrowerHomePage> {
  ...
  void _navigateToHarvest() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => HarvestPage(email: widget.email)),
    );
  }
  ...
  void _navigateToPayments() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PaymentsPage(email: widget.email),
      ),
    );
  }
  ...
  void _navigateToAddOrder() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GrowerOrderPage(email: widget.email),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButtonLocation:
          FloatingActionButtonLocation.endFloat, // Position near bottom nav
