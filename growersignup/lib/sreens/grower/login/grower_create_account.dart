...
class _GrowerCreateAccountPageState extends State<GrowerCreateAccountPage> {
  ...
  static const Color dropdownBackgroundColor = Color(0xFFE8F5E9);
  ...
  void _createAccount() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        await _growerCreateApi.groweraccount(newGrower);
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Sign in successful!')));
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => GrowerBankDetailsSetupPage(email: widget.email)),
        );
      } catch (e) {
