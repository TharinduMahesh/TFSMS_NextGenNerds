          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                detailRow("Payment Status", p.paymentStatus ?? "N/A"),
                detailRow("Payment Date", p.paymentDate ?? "Not Paid"),
                const SizedBox(height: 16),
                const Divider(),
                const SizedBox(height: 16),
                detailRow("NIC", p.nic ?? "N/A"),
                detailRow("Name", "${p.firstName} ${p.lastName}"),
                detailRow("Phone", p.phoneNumber ?? "N/A"),
                detailRow("Address", "${p.addressLine1}, ${p.addressLine2}"),
                detailRow("City", p.city ?? "N/A"),
                detailRow("Postal Code", p.postalCode ?? "N/A"),
