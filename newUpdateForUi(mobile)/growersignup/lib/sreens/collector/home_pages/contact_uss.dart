...
class ContactUssPage extends StatefulWidget {
  ...
  @override
  State<ContactUssPage> createState() => _ContactUsPageState();
}

class _ContactUsPageState extends State<ContactUssPage> {
  ...
  final String emailAddress = 'nipz@gmail.com';
  ...
  void _openWhatsapp(String number) {
    ...
    final Uri whatsappUri = Uri.parse('http://wa.me/$number');
