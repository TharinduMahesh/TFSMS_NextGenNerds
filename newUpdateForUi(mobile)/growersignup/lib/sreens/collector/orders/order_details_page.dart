...
class _OrderDetailsPageState extends State<OrderDetailsPage> with TickerProviderStateMixin {
  ...
  static const Color warningOrange = Color.fromARGB(255, 14, 156, 92);
  static const Color successGreen = Color(0xFF0C330D);
          ...
          SnackBar(
            content: const Row(
              children: [
                ...
                SizedBox(width: 10),
                Text('Collection request accepted successfully!'),
              ],
            ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 15), // Space for navigation
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              'Requested: ${_formatDate(details.placeDate)}',
              style: TextStyle(
                color: Colors.white.withOpacity(0.9),
                fontSize: 12,
              ),
  ...
  Widget _buildGrowerInfoCard(OrderDetails details) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: cardBackground,
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          _buildDetailRow('Phone', details.phoneNumber, Icons.phone, Colors.blue),
          const SizedBox(height: 15),
          _buildDetailRow('Location', '${details.addressLine1}', Icons.location_on, Colors.red),
          if (details.addressLine2 != null && details.addressLine2!.isNotEmpty)
            const SizedBox(height: 15),
            _buildDetailRow('Address Line 2', details.addressLine2!, Icons.location_city, Colors.red),
          const SizedBox(height: 15),
          _buildDetailRow('City', details.city, Icons.location_city_outlined, Colors.orange),
          const SizedBox(height: 15), 
          if (details.postalCode != null && details.postalCode!.isNotEmpty)
            _buildDetailRow('Postal Code', details.postalCode!, Icons.code, Colors.purple),
          const SizedBox(height: 15),
  ...
  Widget _buildActionButtons(OrderDetails details) {
    return Column(
      children: [
        // Accept Collection Button
        SizedBox(
          width: double.infinity,
          child: ElevatedButton.icon(
            onPressed: () => _showAcceptDialog(details),
  ...
  void _showAcceptDialog(OrderDetails details) {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const SizedBox(width: 10),
              Text('Accept Collection', style: TextStyle(color: successGreen)),
            ],
          ),
          content: Text('Are you sure you want to accept this collection request for ${details.totalTea} kg of tea from ${details.growerName}?'),
          actions: [
            TextButton(
