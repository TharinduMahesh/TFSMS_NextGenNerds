...
class _PendingOrdersPageState extends State<PendingOrdersPage> with TickerProviderStateMixin {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Unable to load pending collection requests',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              'You have no pending collection requests at the moment.',
              textAlign: TextAlign.center,
              style: TextStyle(color: textLight, fontSize: 14),
            ),
            const SizedBox(height: 20),
  ...
  Widget _buildOrdersList(List<PendingOrder> orders) {
    return Column(
      children: [
        // Header Section
        Container(
  ...
  Widget _buildOrderCard(PendingOrder order, int index) {
    return Container(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.local_shipping, color: warningOrange, size: 24),
                    ),
