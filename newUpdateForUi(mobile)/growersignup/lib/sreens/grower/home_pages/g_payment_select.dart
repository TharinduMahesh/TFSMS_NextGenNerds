...
class GrowerPaymentDetailsSelectPage extends StatefulWidget {
  final String email;
  const GrowerPaymentDetailsSelectPage({super.key, required this.email});

  @override
  State<GrowerPaymentDetailsSelectPage> createState() =>
      _GrowerPaymentDetailsSelectPageState();
}

class _GrowerPaymentDetailsSelectPageState
    extends State<GrowerPaymentDetailsSelectPage> {
  ...
  void _navigateToHarvest() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => GrowerHarvestPage(email: widget.email),
      ),
    );
  }
  ...
  void _navigateToPayments() {
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder:
            (context) => GrowerPaymentDetailsSelectPage(email: widget.email),
      ),
    );
  }
        ...
        child: Column(
          children: [
            ...
            _buildOrderCard(
              ...
              subtitle: 'View incoming Payment requests',
              ...
              onTap:
                  () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => PaymentsListScreen(email: widget.email),
                    ),
                  ),
            ),
              ...
              onTap:
                  () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) =>
                              PaidPaymentsListScreen(email: widget.email),
                    ),
                  ),
            ),
          ],
