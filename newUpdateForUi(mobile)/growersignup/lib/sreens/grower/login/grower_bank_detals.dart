        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Updated title font style to match GrowerCreateAccountPage
                const Text(
                  'Bank Details',
                  style: TextStyle(
                    fontSize: 28,  // Changed from 24
                    fontWeight: FontWeight.w700,  // Changed from FontWeight.bold
                    color: titleColor,
                      ...
                      children: [
                        ...
                        Center(
                          child: ElevatedButton(
                            ...
                            // Updated button text font style
                            child: const Text(
                              'Submit', 
                              style: TextStyle(
                                fontSize: 18,  // Changed from 16
                                fontWeight: FontWeight.w600,  // Changed from FontWeight.bold
  ...
  Widget _buildTextFieldWithLabel({
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Updated label font style to match GrowerCreateAccountPage
          Text(
            label, 
            style: const TextStyle(
              color: labelColor, 
              fontWeight: FontWeight.w200,  // Changed from FontWeight.w500
          ...
          TextFormField(
            ...
            // Updated text style inside TextFormField
            style: const TextStyle(
