...
class GrowerOrderDetailsSelectPage extends StatefulWidget {
  final String email;
  const GrowerOrderDetailsSelectPage({super.key, required this.email});

  @override
  State<GrowerOrderDetailsSelectPage> createState() => _GrowerOrderDetailsSelectPageState();
}

class _GrowerOrderDetailsSelectPageState extends State<GrowerOrderDetailsSelectPage> {
          ...
          children: [
            ...
            _buildOrderCard(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => GPendingOrdersPage(email: widget.email)),
              ),
            ),
            ...
            _buildOrderCard(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AcceptedOrdersPage(email: widget.email)),
              ),
            ),
          ],
        ),
