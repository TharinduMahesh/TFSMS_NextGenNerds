...
class _GrowerOrderPageState extends State<GrowerOrderPage> {
  ...
  int _bottomNavIndex = 2; // Set to 2 since this is the Orders page
  ...
  static const Color primaryGreen = Color(0xFF0a4e41); // Added definition for primaryGreen
  ...
  void _onBottomNavTapped(int index) {
    ...
    switch (index) {
      ...
      case 3: // Orders List
        // Navigator.pushReplacement(
        //   context,
        //   MaterialPageRoute(builder: (context) => GOrderSelectionPage(email: widget.email)),
        // );
        break;
      case 4: // Messages
        // Navigator.pushReplacement(
